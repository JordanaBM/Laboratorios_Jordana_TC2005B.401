...
exports.post_nuevo_artista = (request, response, next) => {
    const artista = new Artistas(request.body.nombre, request.body.sinopsis, request.file.filename);
    artista.save().then(() => {
...
exports.post_nueva_banda = (request, response, next) => {
    const banda = new Bandas(request.body.nombre, request.body.sinopsis, request.file.filename);
    banda.save().then(() => {
